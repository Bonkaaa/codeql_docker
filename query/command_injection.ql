...
where
  CommandInjectionFlow::flowPath(source, sink)
select 
  sink.getNode(),                
  source,                       
  sink,                                         
  "This command line depends on $@ (source at " +
...
// "`wc -l ${file}`","req.url","`wc -l ${file}`","This command line depends on $@ (source at CommandInjection.js:6).","CommandInjection.js",8,8,"CommandInjection.js",6,6
